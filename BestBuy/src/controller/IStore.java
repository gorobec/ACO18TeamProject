...
//   (boolean or Ticket?) addProductByIdToTicket (int productId)throws NoSuchProductException;

//  boolean removeProductByIdFromTicket (int productId)throws NoSuchProductException;
    // send Ticket to DB
//    buy () throws TicketIsEmptyException(but its impossible, we have to create TicketBuilder
