...
public class LibraryTest {
    ...
    String[] authors12 = {"Автор Forbes1", "Автор Forbes2", "Автор Forbes3", "Автор Forbes4", "Автор Forbes5"};
    ...
    PrintedEdition pe9 = new Magazine("Факты и комментарии", authors9, "EastOne Group", new GregorianCalendar(2016, 11, 11), "RU", "Україна", "A3", 12, 200000,"Day", "общественно-политическое издание");
    PrintedEdition pe10 = new Magazine("Сегодня", authors10, "ЧАО «Сегодня Мультимедиа»", new GregorianCalendar(2017, 01, 23), "RU", "Україна", "A3", 12, 233000,"Day", "общественно-политическое издание");
    PrintedEdition pe11 = new Magazine("Вісник і К", authors11, "А-Прінт", new GregorianCalendar(2016, 12, 11), "UA", "Україна", "A3", 20, 65000,"Week", "інформаційно-аналітичне видання");
    PrintedEdition pe12 = new Magazine("Вокруг света", authors12, "ООО «Издательство „Вокруг света“»", new GregorianCalendar(2016, 07, 01), "RU", "Россия", "A4", 126, 1000,"Month", "научно-популярный");
