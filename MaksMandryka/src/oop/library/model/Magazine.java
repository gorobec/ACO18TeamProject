...
public class Magazine extends PeriodicalEdition {
    public Magazine(String name, String[] authorName, String publisherName, Calendar editionDate, String lang, String country, String format, int pages, int circulation, String period, String subject) {
