...
public class Neurosurgeon extends Surgeon {
    ...
    public String giveAdvice(Patient patient) {
        ...
        fm.format("Neurosurgeon %s is giving some useless advice com.bestBuy.to patient %s and take his money...", getName(), patient.getName());
        return fm.toString();
    }
    ...
    public String provideMedicalAssistance(Patient patient) {
        Formatter fm = new Formatter();
        fm.format("Neurosurgeon %s is doing needless surgery on nervous system com.bestBuy.to patient %s...", getName(), patient.getName());
        return fm.toString();
    }
